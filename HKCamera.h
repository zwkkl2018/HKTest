...
public:
	...
	int GainPlus();
	int GainMinus();
	//int ImgWH(unsigned int& width,unsigned int& height);


	int ImgWH(UINT& width, UINT& height);
	int setImgWH(UINT  width, UINT  height);

	int SetWB(UINT nValue);
